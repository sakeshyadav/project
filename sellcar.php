...
$conn = new mysqli($servername, $username, $password, $dbname);
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        echo "<script>
                ...
                window.location.href = 'sellcar.php'; // Redirect after success
              </script>";
    } else {
...
<body class="bg-light">
    ...
    <div class="container py-5">
        <h2 class="text-center text-primary mb-4">Sell Your Car</h2>

        <!-- Card with the form -->
        <div class="card shadow-lg p-4 rounded-3">
            <form action="sellcar.php" method="POST" enctype="multipart/form-data">
                ...
                <!-- Submit Button -->
                <button type="submit" name="submit" class="btn btn-primary w-100">Submit Details</button>
            </form>
        </div>
    </div>
